        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo">
                <a href="index.jsp">
                    <b class="logo-abbr"><img src="${cp}/bootstrap/images/logo.png" alt=""> </b>
        ...
        <div class="header">    
            <div class="header-content clearfix">
                ...
                <div class="header-right">
                    <ul class="clearfix">
                         <c:if test="${sessionScope.S_USERVO != null}">
...
<!--                     <i class="fab fa-wpforms"></i><span class="nav-text">전자결재</span> -->
    ...
    ***********************************-->
    ...
    <!-- Chartjs -->
    <script src="${cp }/plugins/chart.js/Chart.bundle.min.js"></script>
    <!-- Circle progress -->
    <script src="${cp }/plugins/circle-progress/circle-progress.min.js"></script>
    <!-- Datamap -->
