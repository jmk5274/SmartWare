...
public class TaskHistory {
	...
	public TaskHistory(String task_id, String emp_id, String history, Date change_dt) {
	...
	public String toString() {
		return "TaskHistory [task_id=" + task_id + ", emp_id=" + emp_id + ", history=" + history + ", change_dt="
				+ change_dt + "]";
	}
