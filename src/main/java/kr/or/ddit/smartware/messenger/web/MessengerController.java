...
public class MessengerController {
			...
			try {
				...
				if(extName.equals(".jpg")||extName.equals(".JPG")||extName.equals(".jpeg")||extName.equals(".JPEG")||
					...
					message.setMsg_cont("<img src='chatImgFile?path=C:picture/file/"+fileName+"' style='width:150px; height:150px; border-radius: 30%;'>"+
							"<a href='chatFile?path=C:/picture/file/"+fileName+"' download><br><i class='fa fa-download'></i>"+fileName+"</a>");
				}else {
	...
	*/
	...
	public void chatFile(String path, HttpServletRequest request, HttpServletResponse response, HttpSession session) throws IOException {
	...
	public void chatImgFile(String path, HttpServletRequest request, HttpServletResponse response, HttpSession session) throws IOException {
		ServletOutputStream sos = null;
		FileInputStream fis = null;
		File file = null;
